<script>
    ...
    window.addEventListener("load", () => {
      ...
      for (let lang in languages) {
        ...
        button.addEventListener("click", (event) => {
          ...
          const languageBoxes = [
            ...GTE.contentWindow.document.querySelectorAll("a"),
          ];
          const languageBox = languageBoxes.find(
            (box) => box.querySelector(".text").innerText === languages[lang]
          );
          languageBox.click();
          toggleLanguageModal();
        });
  ...
  if (browser) {
    if (localStorage.getItem("token")) flag = true;
    else flag = false;
  }
...
<nav
  data-aos="zoom-out"
  class=" border-gray-200 py-2.5 bg-neutral-100 dark:bg-gray-900"
>
      ...
      >
        ...
        {:else}
          <li>
            <a
              href="/login"
              class=" transition hover:text-primary-500 hover:scale-110 block py-2 pl-3 pr-4 rounded md:hover:bg-transparent md:border-0 md:p-0 text-gray-600 dark:text-white hover:bg-gray-700 md: hover:bg-transparent"
              >Log in</a
            >
          </li>
          <li>
...
<div class="w-full h-[25vh] md:flex text-center">
  <div
    class="md:w-[25vw] h-[25vh] text-center text-gray-600 dark:text-gray-400"
  >
    <a href="/" class="flex items-center mb-4 sm:mb-0">
      <img
        src="https://github.com/IshaanAdarsh/ezmail/assets/100434702/fa856830-9d12-4ae8-b445-630b7d8ac209"
        class="h-14 m-auto invert dark:invert-0"
        alt="Flowbite Logo"
      />
    </a>
    <p>
  ...
  <div class="md:w-[25vw] h-[25vh] text-center">
    ...
    <p>
      <a
        href="https://www.github.com/nown1ne "
        class="text-gray-600 dark:text-gray-400 hover:underline text-lg"
        >Abhinav</a
      >
    </p>
    <p>
